...
from snp_oracle.utils.bittensor import print_info, setup_bittensor_objects
from snp_oracle.utils.config import config
...
class Miner:
    ...
    def __init__(self, config=None):
        self.forward_module = importlib.import_module(f"snp_oracle.miners.{config.forward_function}")
        self.config = config
