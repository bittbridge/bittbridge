...
```bash
python3 -m neurons.miner --axon.port 80 --axon.external_port 80 --netuid 183 --subtensor.network test --wallet.name miner --wallet.hotkey default
python3 -m neurons.miner --axon.port 8080 --axon.external_port 8080 --netuid 183 --subtensor.network test --wallet.name miner --wallet.hotkey default
python3 -m neurons.miner --axon.port 443 --axon.external_port 443 --netuid 183 --subtensor.network test --wallet.name miner --wallet.hotkey default
```
